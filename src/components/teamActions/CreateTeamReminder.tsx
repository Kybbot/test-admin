...
import { createTeamReminder } from '@/store/actions/reminders';
...
const CreateTeamReminder: React.FC<Props> = ({
  hide,
  user,
  project,
  customer,
  ...
  useEffect(() => {
    if (currentUser) setAssign([currentUser._id]);
  }, [currentUser]);
  ...
  const handleSaveButtonClick = () => {
    ...
    dispatch(createTeamReminder(body));
...
export default CreateTeamReminder;

// function smallPhoto(smallPhoto: any): string | undefined {
